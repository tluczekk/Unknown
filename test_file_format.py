...
results_folder = 'src/results'  # 'path/to/result-folder'
# for mnist
test_mnist_length = 10000
# for kws
keywords_txt_file = 'data/TestKWS/task/keywords.txt'  # 'path/to/keyword.txt'
keywords_document_nb_file = 'data/TestKWS/task/test.txt'  # 'path/to/text-file-with-page-id/valid.txt
# for signature verification
users_txt_file = 'data/TestSignatures/users.txt'  # 'path/to/users.txt'
# for molecule graphs
